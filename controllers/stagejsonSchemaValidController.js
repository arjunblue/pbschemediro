...
var archiveDatabaselink = stageArchibDatabaseRef;
...
var mainDatabaseLink = StageappDatabaseRef;
...
// */
// 
//var uid = "97cc6e9ce6d9b5b62e80c0d87e75d2637c308ba2bfeaa287fa94a1979c47ac22";
...
//                                n = Notification(uid, {foo: "bar", aps:{"alert":NotifyError, "sound":"default"}});
//
...
function sendMessageToUser(deviceId, message) {
  request({
    ...
    headers: {
      ...
      'Authorization': 'key='+stageServerKey
    },
    body: JSON.stringify(
      { "data": {
                    ...
                    if(doc !== undefined){
                        ...
                        if(ios.toLowerCase() == 'iphone'){
                            if(deviceToken !== undefined){
                                var Notification = require('node_apns').Notification,	
                                n = Notification(deviceToken, {foo: "bar", aps:{"alert":NotifyError, "sound":"default"}});
//
                                if (n.isValid()) push.sendNotification(n);
                            }
                        }else{
